...
export function MusicStyles() {
  return (
    <div className="flex gap-2 mt-4">
      ...
      <a
        href="#"
        className="border-solid border border-zinc-300 rounded-lg py-1 px-3 text-[13px] font-semibold flex items-center transition-colors duration-100 hover:bg-zinc-200/50 hover:rounded-lg hover:border-transparent"
      >
        Rock
      </a>
      <a
